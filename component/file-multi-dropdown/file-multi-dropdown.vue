  ...
  computed: {
    ...
    displayedText () {
      return this.hasValue
        ? this.modelValue.map(entry => entry[0]).join(', ')
        : this.placeholder
    },
    maxFilesReached () {
  ...
  >
    ...
    <div
      ...
      :class="{
        ...
        'fura-readonly': readonly || maxFilesReached
      }"
...
<style lang="less" scoped src="./file-multi-dropdown.less"></style>
